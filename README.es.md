...
**Buscando:** Backend Engineer; Database Designer; Data/ETL Engineer; Machine Learning Engineer.

- **Backend Engineer:** Construir y mantener APIs y servicios de producción con enfoque en fiabilidad y observabilidad.
- **Database Designer:** Diseñar esquemas relacionales normalizados y optimizar consultas para casos transaccionales y de reporting.
- **Data / ETL Engineer:** Implementar pipelines de ingestión y ETL robustos que preparen datasets validados para analytics y ML.
...
- **Bases de datos y modelado:** PostgreSQL, diseño de esquemas relacionales, normalización, indexación y optimización de consultas
...
- **Infraestructura:** Docker, CI/CD, contenedores como entorno de desarrollo
- **Prácticas:** Diseño de APIs, tests automatizados, observabilidad, arquitectura liviana
...
- **Soporte ML & preparación de datos:** Preparé datasets limpios, realicé feature engineering y construí pipelines de evaluación usados en experimentos de detección de AFib.
...
- **PPG Data Receiver API** — Receptor FastAPI end-to-end para series temporales PPG de wearables con visualización frontend potenciada por WebSocket (ChartJs). Almacena series validadas y delta-decodificadas como CSV e incluye pasos ETL (Pandas/NumPy) para producir artefactos listos para entrenamiento en investigación de AFib. Stack: FastAPI, WebSocket, Pandas, ChartJs. Repo: https://github.com/MrPocketMonsters/PPGDataReceiverAPI
